...
const nextConfig = {
  ...
  async redirects() {
    return [
      ...
      { source: "/o-nama/",             destination: "/about",   permanent: true },
      { source: "/apartmani",           destination: "/#apartments", permanent: true },
      { source: "/apartmani/",          destination: "/#apartments", permanent: true },
      { source: "/kontakt",             destination: "/#contact", permanent: true },
      { source: "/kontakt/",            destination: "/#contact", permanent: true },
      { source: "/kontaktirajte-nas",   destination: "/#contact", permanent: true },
      { source: "/lokacija",            destination: "/#location", permanent: true },
      { source: "/galerija",            destination: "/#gallery", permanent: true },
