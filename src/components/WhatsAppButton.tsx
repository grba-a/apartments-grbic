...
export default function WhatsAppButton() {
  ...
  return (
    ...
    >
      ...
      <div
        className="pointer-events-none hidden whitespace-nowrap rounded-full bg-white px-4 py-2 text-[12px] font-medium shadow-md transition-all duration-200 md:block"
        style={{
      ...
      >
        <span
          ...
          style={{ backgroundColor: "#25D366", animation: "whatsapp-pulse 2.5s ease-out infinite" }}
        />
